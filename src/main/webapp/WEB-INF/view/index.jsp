...
<link
	...
	rel="icon">
<link
	href="${pageContext.request.contextPath}/resources/frontend/img/apple-touch-icon.png"
...
<!-- Vendor CSS Files -->
<link
	href="${pageContext.request.contextPath}/resources/frontend/vendor/fontawesome-free/css/all.min.css"
	rel="stylesheet">
<link
	href="${pageContext.request.contextPath}/resources/frontend/vendor/animate.css/animate.min.css"
	rel="stylesheet">
<link
	href="${pageContext.request.contextPath}/resources/frontend/vendor/bootstrap/css/bootstrap.min.css"
	rel="stylesheet">
<link
	href="${pageContext.request.contextPath}/resources/frontend/vendor/bootstrap-icons/bootstrap-icons.css"
	rel="stylesheet">
<link
	href="${pageContext.request.contextPath}/resources/frontend/vendor/boxicons/css/boxicons.min.css"
	rel="stylesheet">
<link
	href="${pageContext.request.contextPath}/resources/frontend/vendor/glightbox/css/glightbox.min.css"
	rel="stylesheet">
<link
	href="${pageContext.request.contextPath}/resources/frontend/vendor/remixicon/remixicon.css"
	rel="stylesheet">
<link
	href="${pageContext.request.contextPath}/resources/frontend/vendor/swiper/swiper-bundle.min.css"
	rel="stylesheet">
...
<body>
	...
	<div id="topbar" class="d-flex align-items-center fixed-top">
		<div class="container d-flex justify-content-between">
			<div class="contact-info d-flex align-items-center">
				<i class="bi bi-envelope"></i> <a href="mailto:contact@example.com">${user.email}</a>
				<i class="bi bi-phone"></i> ${user.firstName}
			...
			<nav id="navbar" class="navbar order-last order-lg-0">
				<ul>
					...
					<li class="dropdown"><a href="#"><span>Account</span> <i
						...
						<ul>
							<li><a
								href="${pageContext.request.contextPath}/showMyLoginPage">Login</a></li>

							<security:authorize access="hasRole('MANAGER')">
								<li><a href="${pageContext.request.contextPath}/leaders">Manager</a></li>
							</security:authorize>

							<security:authorize access="hasRole('ADMIN')">
								<li><a href="${pageContext.request.contextPath}/systems">Admin</a></li>
							</security:authorize>
						</ul></li>
					<li class="dropdown"><a href=""><security:authorize
						...
						<div class="tab-content">
							<div class="tab-pane active show" id="tab-1">
								<div class="row gy-4">
									...
									<div class="col-lg-4 text-center order-1 order-lg-2">
										<img
											src="${pageContext.request.contextPath}/resources/frontend/img/departments-1.jpg"
											alt="" class="img-fluid">
									</div>
								</div>
							</div>
							<div class="tab-pane" id="tab-2">
								<div class="row gy-4">
									...
									<div class="col-lg-4 text-center order-1 order-lg-2">
										<img
											src="${pageContext.request.contextPath}/resources/frontend/img/departments-2.jpg"
											alt="" class="img-fluid">
									</div>
								</div>
							</div>
							<div class="tab-pane" id="tab-3">
								<div class="row gy-4">
									...
									<div class="col-lg-4 text-center order-1 order-lg-2">
										<img
											src="${pageContext.request.contextPath}/resources/frontend/img/departments-3.jpg"
											alt="" class="img-fluid">
									</div>
								</div>
							</div>
							<div class="tab-pane" id="tab-4">
								<div class="row gy-4">
									...
									<div class="col-lg-4 text-center order-1 order-lg-2">
										<img
											src="${pageContext.request.contextPath}/resources/frontend/img/departments-4.jpg"
											alt="" class="img-fluid">
									</div>
								</div>
							</div>
							<div class="tab-pane" id="tab-5">
								<div class="row gy-4">
									...
									<div class="col-lg-4 text-center order-1 order-lg-2">
										<img
											src="${pageContext.request.contextPath}/resources/frontend/img/departments-5.jpg"
											alt="" class="img-fluid">
									</div>
								</div>
							</div>
				...
				<div class="row">
					...
					<div class="col-lg-6">
						<div class="member d-flex align-items-start">
							<div class="pic">
								<img
									src="${pageContext.request.contextPath}/resources/frontend/img/doctors/doctors-1.jpg"
									class="img-fluid" alt="">
							</div>
					...
					<div class="col-lg-6 mt-4 mt-lg-0">
						<div class="member d-flex align-items-start">
							<div class="pic">
								<img
									src="${pageContext.request.contextPath}/resources/frontend/img/doctors/doctors-2.jpg"
									class="img-fluid" alt="">
							</div>
							<div class="member-info">
								<h4>Sarah Jhonson</h4>
					...
					<div class="col-lg-6 mt-4">
						<div class="member d-flex align-items-start">
							<div class="pic">
								<img
									src="${pageContext.request.contextPath}/resources/frontend/img/doctors/doctors-3.jpg"
									class="img-fluid" alt="">
							</div>
							<div class="member-info">
					...
					<div class="col-lg-6 mt-4">
						<div class="member d-flex align-items-start">
							<div class="pic">
								<img
									src="${pageContext.request.contextPath}/resources/frontend/img/doctors/doctors-4.jpg"
									class="img-fluid" alt="">
							</div>
							<div class="member-info">
								<h4>Amanda Jepson</h4>
					...
					<div class="swiper-wrapper">
						...
						<div class="swiper-slide">
							<div class="testimonial-wrap">
								<div class="testimonial-item">
									<img
										src="${pageContext.request.contextPath}/resources/frontend/img/testimonials/testimonials-1.jpg"
						...
						<div class="swiper-slide">
							<div class="testimonial-wrap">
								<div class="testimonial-item">
									<img
										src="${pageContext.request.contextPath}/resources/frontend/img/testimonials/testimonials-2.jpg"
										class="testimonial-img" alt="">
									<h3>Sara Wilsson</h3>
									<h4>Designer</h4>
									<p>
						...
						<div class="swiper-slide">
							<div class="testimonial-wrap">
								<div class="testimonial-item">
									<img
										src="${pageContext.request.contextPath}/resources/frontend/img/testimonials/testimonials-3.jpg"
										class="testimonial-img" alt="">
									<h3>Jena Karlis</h3>
									<h4>Store Owner</h4>
									<p>
						...
						<div class="swiper-slide">
							<div class="testimonial-wrap">
								<div class="testimonial-item">
									<img
										src="${pageContext.request.contextPath}/resources/frontend/img/testimonials/testimonials-4.jpg"
										class="testimonial-img" alt="">
									<h3>Matt Brandon</h3>
									<h4>Freelancer</h4>
									<p>
						...
						<div class="swiper-slide">
							<div class="testimonial-wrap">
								<div class="testimonial-item">
									<img
										src="${pageContext.request.contextPath}/resources/frontend/img/testimonials/testimonials-5.jpg"
										class="testimonial-img" alt="">
									<h3>John Larson</h3>
									<h4>Entrepreneur</h4>
									<p>
				...
				<div class="row g-0">
					...
					<div class="col-lg-3 col-md-4">
						<div class="gallery-item">
							<a
								href="${pageContext.request.contextPath}/resources/frontend/img/gallery/gallery-1.jpg"
								class="galelry-lightbox"> <img
								src="${pageContext.request.contextPath}/resources/frontend/img/gallery/gallery-1.jpg"
								alt="" class="img-fluid">
							</a>
						</div>
					</div>
					...
					<div class="col-lg-3 col-md-4">
						<div class="gallery-item">
							<a
								href="${pageContext.request.contextPath}/resources/frontend/img/gallery/gallery-2.jpg"
								class="galelry-lightbox"> <img
								src="${pageContext.request.contextPath}/resources/frontend/img/gallery/gallery-2.jpg"
								alt="" class="img-fluid">
							</a>
						</div>
					</div>
					...
					<div class="col-lg-3 col-md-4">
						<div class="gallery-item">
							<a
								href="${pageContext.request.contextPath}/resources/frontend/img/gallery/gallery-3.jpg"
								class="galelry-lightbox"> <img
								src="${pageContext.request.contextPath}/resources/frontend/img/gallery/gallery-3.jpg"
								alt="" class="img-fluid">
							</a>
						</div>
					</div>
					...
					<div class="col-lg-3 col-md-4">
						<div class="gallery-item">
							<a
								href="${pageContext.request.contextPath}/resources/frontend/img/gallery/gallery-4.jpg"
								class="galelry-lightbox"> <img
								src="${pageContext.request.contextPath}/resources/frontend/img/gallery/gallery-4.jpg"
								alt="" class="img-fluid">
							</a>
						</div>
					</div>
					...
					<div class="col-lg-3 col-md-4">
						<div class="gallery-item">
							<a
								href="${pageContext.request.contextPath}/resources/frontend/img/gallery/gallery-5.jpg"
								class="galelry-lightbox"> <img
								src="${pageContext.request.contextPath}/resources/frontend/img/gallery/gallery-5.jpg"
								alt="" class="img-fluid">
							</a>
						</div>
					</div>
					...
					<div class="col-lg-3 col-md-4">
						<div class="gallery-item">
							<a
								href="${pageContext.request.contextPath}/resources/frontend/img/gallery/gallery-6.jpg"
								class="galelry-lightbox"> <img
								src="${pageContext.request.contextPath}/resources/frontend/img/gallery/gallery-6.jpg"
								alt="" class="img-fluid">
							</a>
						</div>
					</div>
					...
					<div class="col-lg-3 col-md-4">
						<div class="gallery-item">
							<a
								href="${pageContext.request.contextPath}/resources/frontend/img/gallery/gallery-7.jpg"
								class="galelry-lightbox"> <img
								src="${pageContext.request.contextPath}/resources/frontend/img/gallery/gallery-7.jpg"
								alt="" class="img-fluid">
							</a>
						</div>
					</div>
					...
					<div class="col-lg-3 col-md-4">
						<div class="gallery-item">
							<a
								href="${pageContext.request.contextPath}/resources/frontend/img/gallery/gallery-8.jpg"
								class="galelry-lightbox"> <img
								src="${pageContext.request.contextPath}/resources/frontend/img/gallery/gallery-8.jpg"
								alt="" class="img-fluid">
							</a>
						</div>
					</div>
	...
	<!-- Vendor JS Files -->
	<script
		src="${pageContext.request.contextPath}/resources/frontend/vendor/purecounter/purecounter.js"></script>
	<script
		src="${pageContext.request.contextPath}/resources/frontend/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>
	<script
		src="${pageContext.request.contextPath}/resources/frontend/vendor/glightbox/js/glightbox.min.js"></script>
	<script
		src="${pageContext.request.contextPath}/resources/frontend/vendor/swiper/swiper-bundle.min.js"></script>
	<script
		src="${pageContext.request.contextPath}/resources/frontend/vendor/php-email-form/validate.js"></script>
